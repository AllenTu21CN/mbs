...
#include "sanp_avalon_libs_network_protocol_RTSPClient.h"
#include "base/log.h"
...
JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_init__I
...
JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_init__III
...
JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_release
  (JNIEnv *jenv, jobject jobj, jint obj_id)
{
    ClientsMap::iterator itr = g_rtspclients.find(obj_id);
    if(itr == g_rtspclients.end()) {
...
JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_connect
...
JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_play
  (JNIEnv *jenv, jobject jobj, jint obj_id)
{
    GET_OBJ_CLIENT(-1);
...
JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_pause
  (JNIEnv *jenv, jobject jobj, jint obj_id)
{
    GET_OBJ_CLIENT(-1);
...
JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_stop
  (JNIEnv *jenv, jobject jobj, jint obj_id)
{
    GET_OBJ_CLIENT(-1);
...
JNIEXPORT jintArray JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_getAudioInfo
  (JNIEnv *jenv, jobject jobj, jint obj_id)
{
    GET_OBJ_CLIENT(NULL);
...
JNIEXPORT jintArray JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_getVideoInfo
  (JNIEnv *jenv, jobject jobj, jint obj_id)
{
    GET_OBJ_CLIENT(NULL);
...
JNIEXPORT jintArray JNICALL Java_sanp_avalon_libs_network_protocol_RTSPClient_getVideoExtInfo
  (JNIEnv *jenv, jobject jobj, jint obj_id)
{
    GET_OBJ_CLIENT(NULL);
    network::RTSPPullClient::VideoInfo info;
