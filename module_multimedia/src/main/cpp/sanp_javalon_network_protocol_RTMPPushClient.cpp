...
#include "jansson.h"
#include "sanp_javalon_network_protocol_RTMPPushClient.h"
...
JNIEXPORT jint JNICALL Java_sanp_javalon_network_protocol_RTMPPushClient_init
...
JNIEXPORT jint JNICALL Java_sanp_javalon_network_protocol_RTMPPushClient_close
...
JNIEXPORT jint JNICALL Java_sanp_javalon_network_protocol_RTMPPushClient_addStream
...
JNIEXPORT jint JNICALL Java_sanp_javalon_network_protocol_RTMPPushClient_connect
  (JNIEnv *jenv, jobject jobj, jint obj_id)
{
    GET_OBJ_CLIENT();
...
JNIEXPORT jint JNICALL Java_sanp_javalon_network_protocol_RTMPPushClient_disconnect
  (JNIEnv *jenv, jobject jobj, jint obj_id)
{
    GET_OBJ_CLIENT();
...
JNIEXPORT jint JNICALL Java_sanp_javalon_network_protocol_RTMPPushClient_write
