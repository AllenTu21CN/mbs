...
public class Drawable2d {
    ...
    private static final float RECTANGLE_TEX_COORDS[] = {
            //0.25f, 0.75f,     // 0 bottom left
            //0.75f, 0.75f,     // 1 bottom right
            //0.25f, 0.25f,     // 2 top left
            //0.75f, 0.25f      // 3 top right
    ...
    private static final FloatBuffer RECTANGLE_TEX_BUF = GlUtil.createFloatBuffer(
            RECTANGLE_TEX_COORDS);
