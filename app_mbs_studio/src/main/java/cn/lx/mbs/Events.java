...
public class Events {
    ...
    private static final int BASIC_START = 0x100;

    // 可用网络信息变化
    // params: obj=NetInfo
    public static final int NETWORK_ACTIVE_INFO = BASIC_START;

    //////////////////// MBS module events (0x200~0x2ff)

    private static final int MBS_START = 0x200;
    ...
    private static final int UI_START = 0x300;
