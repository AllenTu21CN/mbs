...
package sanp.avalon.libs.media.video;
...
public class VideoEncoderCore {
    ...
    public VideoEncoderCore(int width, int height, int bitRate, File outputFile)
        ...
        if (VERBOSE) LogManager.d("format: " + format);
     ...
     */
    public void release() {
        if (VERBOSE) LogManager.d("releasing encoder objects");
        if (mEncoder != null) {
            mEncoder.stop();
            mEncoder.release();
            mEncoder = null;
    ...
    public void drainEncoder(boolean endOfStream) {
        ...
        if (VERBOSE) LogManager.d("drainEncoder(" + endOfStream + ")");
        ...
        while (true) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if ((mBufferInfo.flags & MediaCodec.BUFFER_FLAG_CODEC_CONFIG) != 0) {
                    ...
                    if (VERBOSE) LogManager.d("ignoring BUFFER_FLAG_CODEC_CONFIG");
                    mBufferInfo.size = 0;
                }
