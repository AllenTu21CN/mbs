...
#include <jni.h>
#include "sanp_avalon_libs_network_protocol_RTMPBandwidthTest.h"
#include "network/protocol/rtmp_client/tools/rtmp_bandwidth_test.h"
#include "base/log.h"

static network::RTMPBandwidthTester g_tester;

JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTMPBandwidthTest_jniInit
...
JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTMPBandwidthTest_jniClose
  (JNIEnv *jenv, jobject jobj)
{
    return g_tester.close();
}

JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTMPBandwidthTest_jniStart
...
JNIEXPORT jint JNICALL Java_sanp_avalon_libs_network_protocol_RTMPBandwidthTest_jniStop
  (JNIEnv *jenv, jobject jobj)
{
...
JNIEXPORT jlongArray JNICALL Java_sanp_avalon_libs_network_protocol_RTMPBandwidthTest_jniGetStatistics
  (JNIEnv *jenv, jobject jobj)
{
